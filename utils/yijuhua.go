...
var yijuhua = []string{
	...
	"我一听到那个人的名字心里便火冒三丈。",
	"People offer sacrifices to the Kitchen God on this day.",
	"今天大家会“祭灶”。 ",
	...
	"接下来，就是见证奇迹的时刻。",
	"Mr.Zhang made an apology for his son’s taking drugs.",
	"张先生为他儿子吸毒道歉。",
	...
	"As a Chinese saying goes, “Celebrate the Lantern Festival“.",
	"中国有句俗话:“正月十五闹元宵”。",
	...
	"她是个内秀的人。",
	"Now millions of players are raving about DrawSomething.",
	...
	"惊涛骇浪，方显英雄本色。",
	"Dad,one day,I’ll make you proud of me.",
	"爸爸，总有一天，我会成为你的骄傲！",
	...
	"十一黄金周要来啦！",
	"The Mid-Autumn Festival means family reunion in China.",
	"中秋节意味着全家团圆。",
	...
	"家有一老，如有一宝。",
	"Tears are the words which the heart can’t say.",
	"眼泪是心无法诉说的话语。",
	...
	"米歇尔，我对你的爱无以复加。",
	"When we’re together,even the coldest day feels warm.",
	"和相爱的你在一起，即使最寒冷的日子都充满了暖意。",
	"When you long for something sincerely, the whole world will help you.",
	...
	"Self-delusion about one’s own attractiveness is a prerequisite to every happy marriage.",
	"自作多情是每一段美好姻缘的必要前提。",
	...
	"When I can see you my body is with you, and when I can’t see you my heart is with you.",
	"看得见你我的身体和你在一起，看不见你我的心和你在一起。",
	"Only dead fish follow the flow.",
	"只有死鱼才随波逐流。",
	"What does youth have that’s worth showing off? Have you ever been old?",
	"年轻有什么好炫耀的？你们老过吗？",
	...
	"任何事情成功关键都是熟能生巧。",
	"If you want to get someone angry, you only need do two things: 1)don’t finish speaking.",
	"想惹人愤怒的话只需要做到两点：1)不把话说完。",
	"You know that maybe it’s time for miracles ’Cos I ain’t giving up on love.",
	"你知道也许已是奇迹来临的时刻，因为我不能对爱放弃。",
	...
	"世间最大最可怕的假设就是多数人将自己假设为聪明人。",
	"Jingle bells jingle bells jingle all the way.",
	"叮叮当，叮叮当，铃儿响叮当……",
	"As long as we’re happy, that’s all that matters.",
	"只要现在是开心的，这就足够了！",
	"When a fuck-up won’t fuck up again, it means he’s no longer happy.",
	"当一个二货不再犯二时，说明他不开心了。",
	"Travel and see the world; afterwards, you will be able to put your concerns in perspective.",
	...
	"我很平凡，但我独一无二。",
	"If you love someone,then set him free.",
	"爱一个人，就是让他自由自在的做他自己。",
	"The so-called “life“, all depends on who you meet.",
	"所谓人生，便是取决于遇见谁。",
	"I keep silence, doesn’t mean I don’t know anything.",
	"我沉默，不代表我不知道。",
	"Take advantage of weekends to pretend you’re happy for a couple days.",
	"趁周末假装开心两天。",
	...
	"没有一个地方可以和家相提并论。",
	"Hats off to our diligent readers  on New Year’s Eve.",
	"向除夕还在学每日一句的同学致敬！",
	...
	"大人们给小孩子压岁钱，预示着能带来好运。",
	"Are you busy visiting and greeting relatives and friends during the Spring Festival?",
	"春节期间，你是不是都忙着拜年呢？",
	...
	"我希望，在不久的未来，芳汀这样的悲剧只会出现在故事里，而不是真实世界里。",
	"Lift up your head princess, if not, the crown falls.",
	"我的公主，请抬起你的头，不然皇冠会掉下来的……",
	"The weather is rotten.",
	"天气真糟糕。",
	"I’m who I’m, I have nothing to hide.",
	"我就是我，无须掩藏。",
	...
	"不要随波逐流，要引领潮流。",
	"The difference between successful persons and others is that they really act.",
	...
	"亲爱的过去，谢谢你给我的所有教训。亲爱的未来，我已经准备好了。",
	"He has big muscles.",
	"他肌肉很发达。",
	"I’m a great believer in luck, and I find the harder I work, the more I have of it.",
	"我很相信运气，而我发现我越努力，我的运气越好。",
	...
	"对明天最好的准备就是今天做到最好。",
	"Although she doesn’t know much about football, she understands his sadness.",
	"她不懂足球，但她懂得他的悲伤。",
	...
	"Music and arts have always played the key role in my life.",
	"音乐和艺术一直在我生命中占据着重要的地位。",
	...
	"记住：当人生很苦逼的时候，你要保持淡定。",
	"Our path is harder,but it leads to a better place.Our road is longer,but we travel together.",
	"这条路虽艰辛，但却是通往理想的正途，这条路虽漫长，好在你我并肩前行。",
	...
	"别为某个所谓的特别时刻而有所保留，因为你生活的每一天都是那么特别。",
	"Thank you Toronto.Thank you for giving me the opportunity to begin my career in the NBA.",
	"感谢多伦多，感谢你让我开始NBA生涯。",
	...
	"有时候，我做我想做的事，其它时候，我做我该做的事。",
	"Don’t moon away the Mid-Autumn Festival.",
	"找点事儿做吧，不要虚度了中秋佳节。 ",
	"From the coma, the wait is over.You loved me back to life.",
	"不再麻木，不再等待，你的爱让我重获新生。",
	...
	"人生不问长短，但求白首同心之人。",
	"So near yet so far, we can be beside each other yet our hearts apart.",
	"这么近又那么远，我们虽近在咫尺，心却天各一方。",
	...
	"我们不能成为那些只是为了柴米油盐拼命工作，却没有时间追求梦想的人。 ",
	...
	"我们注定要失去我们所爱的人，不然怎么知道他们对我们有多么的重要。",
	"Hope my warm “Hello“ will brighten up your World Hello Day.",
	"让我的温暖的问候照亮你的世界问候日。",
	...
	"我们不是因为快乐而感恩，而是感恩让我们变得快乐。",
	"Happiness doesn’t depend on any external conditions. It is governed by our mental attitude.",
	"幸福不依赖于外界环境，而取决于我们的心态。",
	...
	"我不希望我们因为“不得不”而在一起，我希望我们是因为想在一起而在一起。",
	...
	"没有改变，不可能会有进步。无法改变想法的人，什么事情也改变不了。",
	"Victory won’t come to me unless I go to it.",
	"胜利是不会向我走来的，我必须自己走向胜利。",
	"For some men, nothing is written unless they write it.",
	"对于一些人来说，命运是由自己书写的，没有什么是注定的。",
	"Death is so final, whereas life is so full of possibilities.",
	"死了可什么都没了，而活着就有无限的可能。",
	"Life is a roller coaster. You can scream every time you hit a bump, or you can throw your hands up and enjoy the ride.",
	...
	"生活的艺术在于，好好把握每一次的放手与坚持。",
	"Early to bed and early to rise, makes a man healthy, wealthy, and wise.",
	"早睡早起使人健康、富裕又聪明。",
	"It’s how you handle rejections that determines where you’ll end up.",
	"你处理拒绝的方式将会决定你何去何从。",
	...
	"I’m not old! Age is nothing!",
	"我不老！年龄不是问题！",
	"Home is not only where it is,but who they are.",
	"家是那个魂牵梦绕的地方，还有那些一直牵挂的人。",
	...
	"恭喜发财！",
	"May everything fall into your lap.",
	"万事如意！",
	...
	"生活就像热水澡，泡着很舒服，但泡得越久，皱纹也就越多。",
	"All drunken days have their tomorrows.",
	"今日花天酒地，明日潦倒穷途。",
	...
	"最珍贵的宝藏不是金银珠宝，也不是艺术品，不能握在手里，只能用心去感受。",
	...
	"时间宝贵，不要虚掷光阴过他人的生活。不要让周遭的聒噪言论蒙蔽你内心的声音。",
	...
	"Lose yourself on a journey of epic proportions. Wherever you go, no one will ever know.",
	"迷失在如诗般的旅途，你的终点，从未被人知晓！",
	"Whatever happens tomorrow, we’ve had today.",
	"无论明天发生什么，我们至少拥有今天。",
	"Like sunlight, sunset, we appear, we disappear. We are so important to some, but we are just passing through.",
	"像日出日落，出现也罢，消失也罢，就算对某些人至关重要，我们依旧是匆匆过客。",
	...
	"出国留学绝不仅是改善你们自己的未来，也关乎塑造你们的国家、关乎我们共有的世界的未来。",
	"We must accept finite disappointment, but we must never lose infinite hope.",
	"我们必须接受有限的失望，但是不可以失去无限的希望。",
	...
	"生活不断地赐予你许许多多机会，而你唯一需要做的只是把握其中一个。",
	...
	"上帝决定了谁是我们的亲戚，幸运的是在选择朋友方面给我们留有余地。Ethel Watts Mumford",
	"They say a person needs just three things to be truly happy in this world: someone to love, something to do, and something to hope for.",
	"据说一个人在这个世上获得真正的幸福需要三件事情：有人爱，有事做，有所期待。 ",
	"We do not inherit the Earth from our Ancestors; we borrow it from our Children.",
	"我们不是从祖辈那里继承的地球，而是向我们的子孙们借来的。",
	"A mind needs books like a sword needs a whetstone.",
	"要保持剑的锋利就得磨拭，要保持头脑灵光就得看书。",
	"For what do we live, but to make sport for our neighbours, and laugh at them in our turn?",
	"我们活着是为了什么？不就是给邻居当笑柄，再反过来笑他们。—1995",
	...
	"A good life is when you assume nothing, do more, need less, smile often, and realize how blessed you are for what you have.",
	"美好生活就是不瞎想，做得多，要得少，常微笑，意识到你现在是多么的幸运。",
	"Sometimes the hardest part isn’t letting go, but rather learning to start over.",
	"有时候，最困难的不是放手，而是学着如何开始。Nicole Sobon",
	...
	"当幸福的一扇门关闭时，另一扇会打开，但我们常常盯着那扇关闭的门，却没有看到另一扇已经打开。",
	...
	"追寻自己，追求挑战、希望、爱情、愤怒、感恩，追寻光明，追寻黑暗，追寻一切，不留恋过往。",
	...
	"上天会把你带走，看着你，对你说，只有一件事可以让灵魂完整，那就是爱。",
	...
	"I don’t need someone who sees the good in me. I need someone who sees the bad in me and still wants me.",
	"我不需要有人因为我的好而选择我，我希望那人看到我的不好，仍然愿意和我在一起。",
	...
	"生即幸福，所以不要浪费生命为别人而活，要活出你自己的意义，为你热爱的事物奋斗，心无旁骛。",
	...
	"不要羡慕别人做得比你好，只需要每天打破自己的记录，因为成功是你和自己打仗。",
	"The people who get on in this world are the people who get up and look for the circumstances they want, and if they can’t find them, make them.",
	"取得成功的人，都是努力去寻找他们想要的机会，如果找不到，他们便自己创造。",
	...
	"当你还能给予的时候别轻言放弃。只要你不放弃，一切皆有可能。",
	"Life is tough, and if you have the ability to laugh at it you have the ability to enjoy it.",
	"人生很艰难，如果你有笑对人生的能力，你就有享受人生的能力。",
	"If you want the best the world has to offer, offer the world your best.",
	"你若想得到这世界最好的东西，先得让世界看到最好的你。",
	"Life can be unfair sometimes, but that’s no reason to give up on it.",
	"有时候，生活是不公平的，但我们却没理由对此绝望。",
	"Knowing after all the unreturned phone calls, broken-hearts, through the blunders and misread signals, through all the pain and embarrassment you never gave up hope.",
	"经历无数次伤心、自作多情，和数不清的痛苦尴尬后，你依然相信真爱。",
	...
	"我认为没有什么是不切实际，如果你相信自己做得到，就可能做得到。",
	...
	"交许许多多的朋友不是什么奇迹。真正的奇迹是当所有人都弃你而去的时候，还有一个朋友坚定的站在你身边。",
	"Anyone who stops learning is old, whether at twenty or eighty. Anyone who keeps learning stays young. The greatest thing in life is to keep your mind young.",
	"任何停止学习的人都已经老了，无论是20岁还是80岁。坚持学习的人永远年轻，人生最美好的事就是保持年轻的心。",
	"It doesn’t matter what others think of you. It only matters what you think of yourself.",
	"不要太在意别人如何看待你；最重要的是你如何看待自己。",
	"It is better to have loved and lost than never to have loved at all.",
	"宁可曾经爱过而失败，也不要从来未曾有过一次爱。",
	"Be thankful for what you have; you’ll end up having more. If you concentrate on what you don’t have, you will never, ever have enough.",
	"要学会对拥有的一切怀有感恩之心。最终你会得到更多。如果你总是对那些没有得到的东西耿耿于怀，那么你永远也不会满足。",
	...
	"并不是你面对了，任何事情都能改变。但是你不面对，什么也改变不了。",
	"A leader does not impose a decision, he moulds it.",
	"领导者不强加决定于他人，他促使一个决定成形。",
	...
	"已经发生的事你也改变不了，就别浪费时间再想它了。前进，放手，忘了它，就这么回事。",
	...
	"有时，微笑就像创可贴，虽然掩盖住了伤口，但是依然感觉到痛。",
	"If you want to be successful, it’s just this simple. Know what you are doing. Love what you are doing. And believe in what you are doing.",
	"如果你想要成功，这很简单：知道你在做什么，爱你做的事，相信你做的事。",
	...
	"Don’t drive after drinking. I know you don’t want to see me right now.--GOD",
	"酒后别开车，我知道你还不想见到我。--上帝",
	"In life, one step creates the next. Each day is of equal importance, no matter how good or bad. There is no moment in life that does not matter.",
	...
	"你生命中的每次努力都成就了今天的你，感谢生命中那些艰难的岁月，是它们让你变得更强大。",
	...
	"别人都说，人到暮年，比起自己做过的事，会更后悔没有做过一些事情。 ",
	"There are two primary choices in life: to accept conditions as they exist, or accept the responsibility for changing them.",
	"人生两大选择：要么接受现状，要么接受改变现状的责任。",
	"Anything is possible, as long as you set your mind, heart and soul to it.",
	"世界上没有做不到的事，只要你全心全意去做。",
	"Enjoy when you can, and endure when you must.",
	"该享受时纵情享受，该忍受时拼命忍受。",
	"Crying is the refuge of plain women. Pretty women go shopping.",
	"平庸的女人靠哭泣来逃避痛苦，而美丽的女人则去购物。",
	...
	"我们最终都会成为自己梦想成为的那个人，只是有些人早一些，有些人晚一些。",
	...
	"笑别人胖不能让自己瘦，说别人傻不能让自己聪明。你的人生就是解决自己面临的问题。",
	"I must say a word about fear. It is life’s only true opponent. Only fear can defeat life.",
	"这里必须说说恐惧，它是生活惟一真正的对手，因为只有恐惧才能打败生活。",
	"Sometimes it takes a good fall to really know where you stand.",
	"有时候需要狠狠摔一跤，才知道自己站在哪儿。",
	"Only those who will risk going too far can possibly find out how far one can go.",
	"只有那些甘愿冒险不断前行的人，才能够清楚的了解自己能走多远。",
	"Life doesn’t get easier. It’s you that do get stronger.",
	"生活从未变得轻松，是你在一点一点强大。",
	"You are richer today if you have laughed, given or forgiven.",
	"只要你今天笑过、给予过或宽恕过，你就比昨天更富有。",
	"You only live once, but if you do it right, once is enough.",
	"人只能活一次，如果你能以正确的方式活着，一次足矣。",
	...
	"我给你的建议是去结婚吧，如果娶了个贤妻，你会成为幸福的人；如果取了个悍妇，你会成为哲学家。",
	...
	"人的求生意志是无比强烈的，有时甚至压倒一切，这意志使他们即便身处最黑暗的时刻也能坦然面对。",
	...
	"为达成任何有意义的事，需要三个关键条件，第一是努力，第二是坚持，第三是常理判断。",
	...
	"	毋庸置疑，好的事情总会到来。而当它来晚时，也不失为一种惊喜。--电影",
	"Pride relates more to our opinion of ourselves, vanity to what we would have others think of us. ",
	"骄傲多数情况下，无非是我们对自己的看法，但虚荣却指的是我们过于看重其他人对我们的评价。--电影",
	"No spring nor summer beauty hath such grace, as I have seen in one autumnal face.",
	"无论是春天的俏还是夏天的美，都没有秋天的这份优雅。",
	"Goals are not only absolutely necessary to motivate us. They are essential to really keep us alive.",
	"我们不仅仅需要目标来保持前进的动力。我们需要有目标才能真正活下去。",
	...
	"	崭新的一天将会来临，太阳也会散发出更明亮的光芒。这些故事中的主角，有很多机会半途而废，但他们永往直前，因为他们相信这世上一定存在着善良。--电影",
	...
	"	尽管被时间消磨，被命运削弱，依旧去奋斗、探索、寻求，而不屈服。--丁尼生",
	...
	"快乐是发自内心的。它与你获得了多少掌声，赢得了多少赞扬无关。快乐的真正意义在于，你相信，自己所奋斗的一切都有意义。	",
	...
	"	成功的人也会遇到很多问题，他们只是坚信没有东西可以阻止他们前进。",
	"When the going gets tough, the tough gets going．",
	"	艰难之路，唯勇者行。	",
	"To do nothing is the way to be nothing.",
	"	没有任何行动是通往一事无成的途径。	",
	"Many people lose the small joys in the hope for the big happiness.",
	"很多人希望获得大的快乐，因而错失小的乐趣。	",
	...
	"	人生有很多选择… 你不是双手握住索性跟着走，就是坐在一旁观看。",
	"They always say time changes things, but you actually have to change them yourself.",
	"	人们常说某些事会随时间改变，但事实上你必须自己改变它们。	",
	"The conditions of conquest are always easy. We have but to toil awhile, endure awhile, believe always, and never turn back.",
	"	克服困难的条件一直都很简单。我们只需要努力一会儿、坚持一会儿、永远保持信念，且绝不折返。	",
	"The only way to achieve the impossible is to believe that it is possible.",
	"	实现“不可能”的唯一办法就是相信它是可能的。--	",
	"If you’re quiet, you’re not living. You’ve got to be noisy and colorful and lively.",
	"生活，没必要太过安静。只有喧闹、多姿多彩且活泼生动才能算是真正的生活。",
	"Losing is a learning experience. It teaches you humility. It teaches you to work harder. It’s also a powerful motivator.",
	"	失败是一个学习经验，它教你谦逊，让你更努力，它也是一个强大的激励来源。",
	"People who live the most fulfilling lives are the ones who are always rejoicing at what they have.",
	"永远对所拥有感到欣喜的人，是生活最富足的人。",
	"The reading of all good books is like a conversation with the finest men of past centuries.",
	"	读好书，如同与先哲们交谈.",
	"Your living is determined not so much by what life brings to you as by the attitude you bring to life.",
	"	你的人生主要不是取决于生活带给你什么，而是你带何种态度至生活里。",
	"In order to do something you’ve never done, you have to become someone you’ve never been.",
	"	为了做你从没做过的事，你必须成为另外一个人。	",
	"We all have our own life to pursue, our own kind of dream to be weaving, and we all have the power to make wishes come true, as long as we keep believing.",
	"我们都有自己要追求的人生，自己要编织的梦想，我们都有能力实现愿望，只要我们持续相信。	",
	...
	"冒险是一种心态和精神。与之而来的是绝对的信念，这样无论生死，都无所畏惧。	",
	"Any activity becomes creative when the doer cares about doing it right, or better.",
	"当你专注把事情做好，或做得比原来更好，任何事情都可以创新。",
	...
	"	奥利弗站了起来，手里捧着碗，胆战心惊地朝管事的走了过去。他极度饥饿又心存恐惧。",
	"The secret of success in life is for a man to be ready for his opportunity when it comes.",
	"	人生成功的秘密在于，当机会来临时，他已准备好。	",
	...
	"以无限的可能性开始每一天。我们本身决定着这一天是否进步或安心。",
	...
	"时间可以吞噬一切，但它丝毫不能减少的是你伟大的思想、幽默、善良和勇气。--",
	"The greatest gift that you can give to others is the gift of unconditional love and acceptance.",
	"	你能给别人的最好礼物，是无条件的爱与包容。	",
	...
	"家，我会回家，想办法让他回来。不管怎样，明天又是全新的一天。--",
	"Visualize this thing that you want, see it, feel it, believe in it. Make your mental blue print, and begin to build.",
	"想你所想，去看、去感受、去相信。心里画一个蓝图，并努力让它绚烂多彩。",
	...
	"曾经的相濡以沫，到如今的形同陌路，甚至还不如路人，一切都回不去了。--简·奥斯汀",
	...
	"朋友无数也敌不过当所有人都弃你而去时，有一个能坚定地站在你身旁。",
	...
	"保护你的纯真，它让我们有勇气去做实际心态所不允许的事。",
	"Making someone happy is perhaps the humblest way of approaching happiness.",
	"获取快乐的最简单方法或许就是让他人感受到你的快乐。",
	"Action is the real measure of intelligence.",
	"行动是智慧的真正衡量标准。",
	"The best and most beautiful things in the world cannot be seen or even touched. They must be felt with the heart.",
	"世上最美好的事物看不着也摸不到，它们只能用心感觉。",
	"Happiness belongs to  those who dream dreams and are ready to pay the price to make them come true.",
	"快乐属于那些敢于梦想，并且时刻准备去实现梦想的人。",
	...
	"如果我看得比其他人远，那是因为我站在巨人的肩膀上。",
	"The most important quality for an investor is temperament, not intellect.",
	"投资人最重要的品质不是智慧，而是性情。--巴菲特",
	...
	"当我们在一起时，光会更亮。没有什么是我们做不了的，没有我们赢不了的比赛。",
	...
	"我有点儿左右两难，生活是座迷宫，爱是个谜，我不知道该去哪儿，我一个人做不到。",
	...
	"同自己内心的敌人斗争永远是最艰苦的，那片战场也是地球上最孤独的地方。",
	...
	"你已经受够了白费力气，请不要自暴自弃，也不必太快抽离，有时我们终能实现梦想只要我们竭尽全力。",
	...
	"世界上最孤独的就是当你照镜子时，会为镜子里的人感到羞愧",
	"I was born with an enormous need for affection, and a terrible need to give it.",
	"我天生对爱有巨大的需求，而且有强烈的愿望去给予爱。——奥黛丽·赫本",
	"Do not argue with an idiot.He will drag you down to his level and beat you with experience.",
	"你永远不能战胜一个彻头彻尾的傻子，因为他会把你的智商拉到跟他一样的水平，然后用丰富的经验打败你。",
	...
	"我们继续跳着，而我也不再掩饰笑意。我很轻易就沉浸在他的眼神与臂弯里了。我想要像这样和他永远跳下去，在没有音乐的体育馆地板上滑动着。",
	"I like the dreams of the future better than history of the past!",
	"对于回忆过去，我更喜欢憧憬未来！--托马斯•杰斐逊",
	...
	"每个人遇到难关都会和我一样这么想，真希望这一切都没发生。但是那不由人们所决定，你所能决定的是，是在给予你的时间内选择去做什么。",
	...
	"彻底消除和根绝欲望后，生老病死，悲伤，哀痛，苦难和不幸和绝望就一扫而光。",
	...
	"童年原是一生中最美妙的阶段，那时的孩子是一朵花，也是一颗果子，是一片朦朦胧胧的聪明，一种永远不息的活动，一股强烈的欲望。--巴尔扎克",
	"Life is too short for long–term grudges.",
	"人生短暂，何必长期心怀怨念。",
	"If your heart is willing, it makes thousands of ways. If your heart is unwilling, it makes thousands of excuses.",
	"如果你的内心愿意，就有成千上万种方法，如果你的内心不愿意，就有成千上万个借口。",
	"Anything one man can imagine, other men can make real.",
	"但凡人能想象到的事物，必定有人能将它实现。--凡尔纳",
	...
	"我想揭示大自然的秘密，用来造福人类。我认为，在我们的短暂一生中，最好的贡献莫过于此了。--爱迪生",
	"The ideals which have lighted my way, and time after time have given me new courage to face life cheerfully have been kindness, beauty and truth.",
	"有些理想曾为我们引过道路，并不断给我新的勇气以欣然面对人生，那些理想就是——真、善、美。--爱因斯坦",
	...
	"每当两人相遇时，实际上有六个人存在：那就是各自眼中的自己，各自在对方眼中的自己和各自真实的自我。——劳伦斯·彼得",
	...
	"我们需要摆脱胸无大志的状况，人们想要开好车、穿华服、住豪宅，却不愿为之付出艰苦努力。 --奥巴马",
	...
	"Action is character. If we never did anything, we wouldn’t be anybody. —An Education",
	...
	"我们必须勇于做自己，不管这个自己有多可怕，有多怪异。——May Sarton ",
	"Don’t go around saying the world owes you a living. The world owes you nothing. It was here first.-Mark Twain",
	"别到处说世界亏欠了你。世界什么都不欠你的，你还没出生它就在这儿了。-马克·吐温",
	...
	"有的鱼是永远关不住的，因为他们属于天空。—",
	"Gaming is often seen as an unsociable and solitary pursuit.",
	"通常来说，人们认为玩游戏是个离群索居的爱好。",
	"Low self-esteem is like driving through life with your hand brake on.—Maxwell Maltz",
	"缺乏自信，就好像拉着手刹在人生道路上行驶。—麦斯威尔·莫尔茨",
	"Women will never be equal to men until they can walk down the street with a bald head and a beer gut, and still think they are sexy.",
	" 女人永远不会跟男人平等，直到有一天她们能够秃着头挺着啤酒肚在街上晃悠，还觉得自己倍儿性感。",
	"It seems to be a perpetual rule that flops are produced elatedly and masterpieces painstakingly.",
	"自古欢愉酿糟糠，从来痛苦出杰作。",
	...
	"在政府推动下，全英将有一半的小学采用中国传统数学教学方法，以防止英国小学生落后于亚洲的小学生。",
	...
	"要认真地生活，只有这样，当你走到生命的尽头时，你才会含笑而眠，而周围的人却痛苦不已。",
	"I used to rule the world.Seas would rise when I gave the word.—Viva La Vida",
	"大千世界曾由我主宰。巨浪也曾因我之命澎湃。—",
	"I’m the type of person,if you ask me a question, and I don’t know the answer,I’m gonna  tell you that I don’t know. —The Pursuit of Happyness",
	...
	"被一个人深深地爱着将给你力量，深深地爱着一个人将给你勇气。—宫崎骏",
	...
	"假使我又见你，隔了悠长的岁月，我该如何致意？以沉默，以眼泪。—拜伦",
	...
	"在我们的一生中至少有两次应该奋不顾身：一次为爱情，一次为梦想。 —",
	"You must not let anyone define your limits because of where you come from. —Ratatouille",
	"不要因为出身低就让别人限制了你发展的机会。—料理鼠王",
	"Everyone’s heart is a piece of sea, shining bottomless blue.",
	"每个人的心都是一片海，闪耀着深不见底的幽蓝。",
	"I don’t want to win unless I know I’ve done my best.  —Without Limits",
	"除非我知道我已经做到最好了，否则我是不会想着赢的。 —",
	"When life gives you a hundred reasons to cry, you can show that you have a thousand reasons to smile.",
	"当生活给你一百个理由哭泣时，你就拿出一千个理由笑给它看。 ",
	"Life without love is like a tree without blossoms or fruit. —Kahlil Gibran",
	"缺少爱的生活就像从未开花结果的枯树。—卡里·纪伯伦",
	...
	"—A: What kind of mooncake do you like?  —B：The classic one, like Five Seeds Mooncake. How about you?   —A：Wow. Awesome. I like the fruit-flavor mooncake.",
	"A：“你喜欢什么馅儿的月饼？” B：“像五仁君那种超经典的。你呢？” A：“呵呵哒，还真是重口味。我还是比较喜欢水果味月饼。”",
	...
	"永远不要以貌取人。",
	"When you are loved by a person, you will feel that you are the happiest person in the world.  —He is dragon",
	"当你被一个人爱着的时候，你就会觉得自己是世界上最幸福的人。 —",
	"Let us be grateful to people who make us happy, because they are the charming gardeners who make our souls blossom.",
	"让我们感谢那些使我们快乐的人，他们是使我们灵魂开花的可爱园丁。—马塞尔·普鲁斯特",
	"When I think of a word to express the music,I found the Vienna.When I think of a word to express the mystery,I found the Prague.",
	"当我想以一个词来表达音乐时，我想到了维也纳。而当我想以一个词来表达神秘时，我只想到了布拉格。 —尼采",
	"The reality of one person is not in what he reveals to you, but in what he cannot reveal to you.",
	"一个人的实质，不在于他向你显露的那一面，而在于他所不能向你显露的那一面。—纪伯伦",
	...
	"无论你去哪里，都要让每一个来找你的人离开时都比之前更快乐些。",
	"Knowledge is a treasure, but practice is the key to it.  — Fuller",
	"知识是一宝库，而实践就是开启宝库大门的钥匙。 — 富勒",
	"Do you know that dolphins are so smart that within a few weeks of captivity, they can train people to stand on the very edge of the pool and throw them fish?",
	...
	"人生中没有后悔，只有教训。 —珍妮佛‧安妮斯顿",
	"Adversity has the effect of eliciting talents, which in prosperous circumstances would have lain dormant. — Horace",
	"逆境可以引出一个人的才能，它在富足的环境只是潜伏著。— 贺拉斯",
	"Sometimes when you think the sky is about to fall down, you might be standing tilted. —2 Broke Girls",
	"有时候你以为天要塌下来了，其实是自己站歪了。 —破产姐妹",
	"I know nothing with any certainty,but the sight of the stars makes me dream. —Vincent van Gogh",
	"我不知道世间有什么是确定不变的，我只知道，只要一看到星星，我就会开始做梦。—文森特·梵高",
	"The key to immortality is living a life worth remembering. —I. Am.Bruce.Lee",
	"若想死后永垂不朽，首先得活得精彩。 —我是李小龙",
	"There was never a night or a problem that could defeat sunrise or hope. — Bernard Williams",
	"如同夜晚不能阻止日出，难题也无法抹杀希望。 —伯纳德‧威廉士",
	"Happiness doesn’t depend on who you are or what you have; it depends solely on what you think. — Dale Carnegie",
	"快乐不是取决于你是何人或你拥有什么，它只取决于你的想法。 —戴尔‧卡内基",
	"The world doesn’t just disappear when you close your eyes. —Memento",
	"即使闭上眼睛，世界并没有消失。 —",
	"If you are honest to oneself , no one in the world can deceive you.",
	"当你对自己诚实的时候，世界上没有人能够期骗得了你。",
	...
	"This is where all dreams begin.——THE BFG",
	"我所有的梦都是从这里开始的。——圆梦巨人",
	...
	"“You can’t get rid of fear.It’s like Mother Nature,you can’t beat her or outrun her,but you can through it.You can find out what you’re made of.        “",
	...
	"“The Kingsoft PowerWord is not only for words, but also for the beauty of English. “",
	"金山词霸，不止于查词，发现英文之美。",
	...
	"One way at a time,I will try to lend these broken hands of mine.Give me strength be my light.",
	"每次一程，我会试试借出我残缺的双手。做我的光芒给我力量。",
	...
	"当你喜悦时，不要轻易地承诺。当你悲伤时，不要轻易地回复。当你愤怒时，不要轻易做出决定。三思而后行，明智之法。",
	...
	"Legends are but stories about ordinary people doing extraordinary things. Of course, it takes courage and imagination. Not everybody has that.",
	"传说不过是平凡人做不平凡的故事，当然需要勇气和想象力，不是每个人都能做到的。",
	...
	"没有没希望的情况，只有对情况渐渐放弃希望的人。",
	"Ability may get you to the top,but it takes character to keep you there. ",
	"能力会让你青云直上，到达顶峰，但必须靠足够的人格魅力，才能让你留在那里。",
	"l learned everyone dies alone,but if you mean something to someone,if you helped someone,if even a single person remembers you,then you never really die.",
	"我学到了每个人都会孤独地死去，但是如果你的存在对某个人意义非凡，或者你帮助过某个人，哪怕有一个人能够想起你，你就不会真的死去。",
	...
	"你知道多少或你认识谁并不重要，重要的是要让人知道你。",
	"A ship is always safe at the shore - but that is not what it is built for.",
	"船靠岸边总是安全的，但那不是建造它的目的。",
	...
	"“Only my spouse coral’s the setting sun,draw near me pale face and show bright-colored brilliance. “",
	"只愿我的爱人是珊瑚般的夕阳，凄近我苍白的面孔，赐予我无尽的光茫。",
	...
	"有人说，爱过，失去过，总胜于从未感受爱。",
	"Rich blessings for health and longevity is my special wish for you in the coming year.I hope you have a most happy and prosperous New Year.",
	"衷心祝福你在新的一年里健康长寿.望你在新的一年里幸福安康。",
	...
	"May the force be with you. ——Rogue One：A Star Wars Story",
	"愿原力与你同在。——",
	...
	"当整个世界分崩离析。我只想一点一点把它拼凑回来，这总归不是什么坏事。",
	...
	"如何跟你不想失去的人说再见？我没有说再见。我什么也没说。我就这样走了。",
	"Some of us get dipped in flat, some in satin, some in gloss. But every once in a while you find someone who’s iridescent, and when you do, nothing will ever compare.",
	...
	"人生就是一场旅行，不要在乎目的地，只需在乎沿途的风景以及看风景的心情。",
	...
	"忧愁的时候，我想念你，就如同凛冽冬日里想念暖阳；烦躁的时候，我想念你，就如同炎炎烈日下想念绿荫。",
	"A bright moon and stars twinkle and shine. Wish you a merry Lantern Festival, bliss, and happiness.",
	"皓月闪烁，星光闪耀，元宵佳节，美满快乐！",
	"Food is fuel.You get picky about what you put in the tank, your engine is gonna die.----Ratatouille",
	"食物就是燃油。你对燃油挑三拣四，你的引擎就会熄灭。——",
	...
	"A reader lives a thousand lives before he dies… The man who never reads lives only one.",
	"阅读的人在临终前经历了一千个人生…… 从不阅读的人只经历一个人生。",
	...
	"真实的女孩不完美，完美的女孩不真实。",
	"A free man starts a long journey,whose conclusion is uncertain.",
	...
	"The girl who laughs and talks a lot and seems very happy is also the one who may cry herself to sleep.",
	"那个总是谈笑风生，看起来很开心的女孩，也是那个可能会一个人哭到睡着的女孩。",
	"What we anticipate seldom occurs; what we least expect generally happens. ----Benjamin Disraeli",
	"我们所预料的事情很少发生，我们最始料不及的事情却往往发生了。——本杰明·迪斯雷利 ",
	...
	"胜利不是用赢输定义的，而是用努力定义的。如果你能如实地说，“我尽了我所能，我付出了所有”，那么你就是一个胜利者。——沃尔夫冈·谢德勒",
	...
	"我不想谋生；我想生活。-- 奥斯卡·王尔德",
	"A star has 5 ends; A square has 4 ends; A triangle has 3 ends; A line has 2 ends; A life has one end. Our happiness has no end.",
	"星星有五个终点，正方形有四个终点，三角形有三个终点，一条线有两个终点，人生只有一个终点，而我们的幸福没有终点。",
	...
	"一个笑容，可以开始一段友情。一个词语，可以结束一段争吵。一个眼神，可以挽回一段感情，一个人，可以改变你的一生。",
	...
	"我们必须学习依现实情况调整自己的想法，而不是试图把现实套在我们想法的框架中。– 维克多·丹尼尔",
	...
	"Every man has his secret sorrows which the world knows not,and oftentimes we call a man cold when he is only sad. - Criminal Minds",
	...
	"Nuptial love makes mankind; friendly love perfects it; but wanton love corrupts and debases it.— Bacon",
	"婚姻之爱创造人类，友谊之爱使其完美，但不负责的爱腐蚀并使人类堕落。– 培根",
	...
	"如果你不喜欢某件事，就去改变它；如果你不能改变它，就改变你的态度。不要抱怨。",
	...
	"We must accept finite disappointment, but we must never lose infinite hope.",
	"我们要接受失望，因为它是有限的；但千万不可失去希望，因为它是无穷的。",
	"Be more concerned with your character than your reputation, because your character is what you really are, while your reputation is merely what others think you are.",
	"在乎你的性格，而不是你的声誉。性格代表你是谁，而声誉只是人们以为你是谁。",
	...
	"If you are not willing to learn and grow, no one can help you. But if you are determined to learn and grow, no one can stop you.",
	"如果你不愿意学习和成长，没人能帮助你；但如果你决意要学习和成长，也没人能阻拦你。",
	"Man is always more than he can know of himself; consequently, his accomplishments, time and again, will come as a surprise to him.",
	"人总是比所了解的自己还强，因此，他的成就，将一再的超出自己的意料。",
	...
	"不要说你时间不够，你每天被赋予的小时数和海伦凯勒、巴士德、米开朗基罗、杰弗逊、及爱因斯坦完全一样。",
	...
	"做你自己，说你想说，介意的人不重要，重要的人不介意。——Bernard M. Baruch",
	...
	"不要嘲笑一个年轻人的做作，他只是一次又一次地在找寻真正的自己。——Logan Pearsall Smith",
	...
	"布兰：人在恐惧的时候还能勇敢吗? 奈德：人唯有恐惧的时候方能勇敢。—— ",
	...
	"Chinese Dragon Boat Festival is also known as Duanwu Festival, which falls on the fifth day of the fifth lunar month every year. ",
	"每年农历五月初五为“龙舟节”又称端午节。",
	...
	"拿了银牌，人们迟早会忘记你。但是拿了金牌，你就是榜样。人们永远不会忘记榜样。——摔跤吧！爸爸",
	"Never trouble trouble till trouble troubles you.",
	"麻烦没来找你，就别去自找麻烦。",
	...
	"想想你目前拥有的幸福，这每人都有很多 – 別回想以前的不幸，这每人或多或少都有一点。——查尔斯·狄更斯",
	...
	"只要持续的为梦想而努力，尽所能得让梦想实现，梦想是不会伤害任何人的。",
	...
	"还是结婚吧；如果你找到了一位好妻子，你会变得幸福；如果你有找到了一位坏妻子，你会成为一位哲人。——苏格拉底",
	...
	"必须说“可以”的时候，真心诚意地说出来；必须说“不行”的时候，毫不畏惧地说出来。",
	"Apart from tears, only time could wear everything away. While feeling is being processed by time, conflicts would be reconciled as time goes by.",
	...
	"若你真的想做某事，你得努力上进、善用机会，而最重要的是决不放弃。",
	...
	"Forget all the reasons why it won’t work, and believe the one reason why it will. ",
	"忘掉所有那些“不可能”的借口，去坚持那一个“可能”的理由。",
	"Maybe the only way to console us is to have a warm quilt and an unknown dream.",
	"也许只有夜晚一床温暖的棉被和一个好梦才可以慰藉我们。",
	...
	"我是无名之辈，你是谁？你也是无名之辈？——Emily Dickinson",
	...
	"If a woman is not sexy, she needs emotion; if she is not emotional, she needs reason; if she is not reasonable, she has to know herself clearly. If not, she has only misfortune.",
	...
	"Love yourself. It is important to stay positive because beauty comes from the inside.",
	"爱自己，保持乐观很重要，因为美丽是由内而外散发出来的。",
	...
	"有时候，你要做的就是，昂起自己的头，不让眼泪掉下来，然后潇洒的说一声：再见……",
	...
	"He, who is content with the least, is the richest, for content is the wealth of nature.",
	"知足常乐者最富有，因为知足本身就是天然的财富。",
	"Unless you try to do something beyond what you have already mastered, you will never grow.",
	"只有去尝试做一些你不熟悉的事情你才能有所成长。",
	"You have to believe in yourself. That’s the secret of success.--Chaplin",
	"人必须相信自己，这是成功的秘诀。——卓别林",
	...
	"To be a happy man: read, travel, work hard and care for the body and mind.",
	"做一个幸福的人，读书，旅行，努力工作，关心身体和心情。",
	"The best way to find out if you can trust somebody is to trust them. - Hemingway",
	"确认某些人是否可以信任的最好的办法，就是信任他们。——海明威",
	"Tell our enemies that they may take our lives, but they’ll never take our Freedom!",
	"告诉敌人，他们也许能夺走我们的生命，但是，他们永远夺不走我们的自由！",
	"A little bit more happy every day is the best return.",
	"每天多开心一些就是对自己最好的回报。 ",
	"Good, better, best. Never let it rest. Till your good is better and your better is best.",
	"好，更好，最好，别让它停止。直到你的好成为更好，你的更好成为最好。",
	...
	"世上最简单的事就是做自己，最困难的事是成为别人眼中的自己。别让他人使自己陷入困难的境地。",
	...
	"Crouch down and hold your knees when you are depressed. Forgive others and yourself.",
	"郁闷的时候蹲下来抱抱自己，原谅别人也原谅自己。",
	"No matter when you start, it is important that you do not stop after starting. No matter when you end, it is more important that you do not regret after ending.",
	"不论你什么时候开始，重要的是开始之后就不要轻言放弃;不论你什么时候结束，重要的是结束之后就不要后悔。",
	"The positive thinker sees the invisible, feels the intangible, and achieves the impossible.",
	"心态积极的人能够看到别人无法看到的，感悟别人无法感悟的，完成他人无法完成的。",
	"We are born losers, so we must do our best  to get what we want.",
	"我们天生就是输家，所以必须竭尽全力才能得到我们想要的东西。——",
	...
	"如果自己不找准定位，别人就会按他们的想法给我定位。",
	"No matter how bad it gets,the sun will always come out.",
	"不管阴雨如何连绵，太阳总会出现。",
	"One day someone will walk into your life, then you realize love is always worth waiting for. ",
	...
	"你是某个人生命拼图中的一小块，也许你永远都不知道自己的位置在哪儿，但请记住: 没有你，他的生命是不完整的。",
	...
	"Only in your smile, I just have to breathe. -- Dickens",
	"只有在你的微笑里，我才有呼吸。——狄更斯 ",
	...
	"如果我们做该做的事，所有的胜算都会高一点。",
	"Be regretting your own mistakes, and strive not to repeat, which is true repentance.",
	"悔恨自己的错误，而且力求不再重蹈覆辙，这才是真正的悔悟。——海明威",
	"Thanks to Cupid’s arrow, we meet each other.",
	"我们的相遇，是上帝的指引，月老的安排。——",
	...
	"这辈子我等你，没有因为，没有所以。",
	"For every beauty there is an eye to see it. For every truth there is an ear to hear it. For every love there is a heart to receive it.",
	"每一种美，都会有一双眼睛能看到；每一个真相，都有一双耳朵会听到；每一份爱，总会有一颗心会感受到。",
	"Let Plato be your friend, and Aristotle, but more let your friend be truth.",
	"与亚里士多德为友,与柏拉图为友,更与真理为友。——",
	"Our greatest glory is not in never falling , but in rising every time we fall.",
	"我们最值得自豪的不在于从不跌倒，而在于每次跌倒之后都能爬起来。",
	...
	"我们总是忘记这一点:快乐不是得到我们所没有的，而是认识并感恩我们所拥有的。",
	"The snow glows white on the mountain tonight.",
	"霜辄夜白，日暮尽苍生远。",
	"There will be obstacles.There will be doubters.There will be mistakes.But with hard work,there are no limits.",
	"你将遇到障碍、遇到怀疑你的人，你也会犯错，但透过努力，你不会有极限。",
	...
	"I’m afraid my best friend has a best friend of his own.It feels like being in broken relationship.",
	"我好怕我的好朋友有了自己的好朋友。感觉像失恋了一样。",
	"​​​​The more desire you have, the more panic and anxious you become.",
	"有多少欲望，就有多少慌张，就有多少焦虑。",
	"Up to now, everything is all right. More power to your elbow!",
	"迄今为止，一切都好，加油干吧!",
	"May all your troubles be litle ones.",
	"但愿你的一切烦恼都是小事。",
	"Don’t undermine your worth by comparing yourself and others.",
	"别拿自己和别人比较，这样只会破坏你的价值。",
	"When the world says “Give up“, I hope there are whispers saying “Try it one more time.“",
	...
	"非常奇怪的是，这世上匹夫之勇非常常见，而道德上的勇气几乎没有。",
	...
	"小心你怎么评断他人，特别是朋友。你不能片刻间总结一个人的人生。",
	...
	"在某些时刻，你得自己决定要成为什么样的人，不能让别人帮你做决定。",
...
func RandomYiJuHua() string {
	yjh, _ := slice.Random(yijuhua)
	return yjh
}
